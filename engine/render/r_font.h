...
public:
	...
	void	Draw(scp_t pos, int align, int height, col4_t col, bool verticalFlag, const char* str);
...
private:
	...
	void	DrawTextLine(scp_t pos, int align, int height, col4_t col, bool verticalFlag, const char* str);
